 ...
 const handleRouteSubmit = async (e) => {
  ...
  try {
   ...
   const url = isEditingRoute
    ...
    : "http://localhost:8083/api/routes";
 ...
 return (
  ...
  <div
   ...
   style={{
    ...
    margin: "-2rem", // Negative margin to counter the default page padding

    width: "calc(100% + 4rem)", // Compensate for the negative margins

    position: "relative", // Ensure it stays above the background image

    marginBottom: "-8rem", // Extend down to cover bottom edge

    paddingBottom: "8rem", // Add padding to compensate for negative bottom margin
  ...
  >
   ...
   <div className="text-center mb-8">
    ...
    <div className="flex flex-col items-center">
     ...
     <div className="w-32 h-1 bg-yellow-400 mb-3"></div>
     ...
     {showBusForm && (
      ...
      <div className="flex justify-center items-center">
       ...
       <Card
        ...
        className="max-w-md w-full bg-gray-200 shadow-lg rounded-xl p-8

                transition-all duration-300 ease-in-out

                hover:shadow-2xl hover:scale-105 hover:bg-gray-300

                transform cursor-pointer border border-gray-300"
       ...
       >
        ...
        <div className="text-center mb-8">
         ...
         <div className="mt-2 h-0.5 w-16 bg-blue-500 mx-auto rounded-full"></div>
    ...
    <div className="space-y-6">
     ...
     <div className="flex justify-end mb-4">
      ...
      <button
       ...
       className="text-white flex items-center gap-2 hover:text-gray-200 transition-colors duration-200"
